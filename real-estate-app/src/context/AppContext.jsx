...
export const AppProvider = ({ children }) => {
  const [products, setProducts] = useState([
    { id: 1, name: "Luxury Villa", price: 5000000, description: "A beautiful luxury villa", images: ["/images/LuxuryVilla/ronin-kbrPWt77jgQ-unsplash.jpg", "/images/LuxuryVilla/douglas-sheppard-9rYfG8sWRVo-unsplash.jpg", "/images/LuxuryVilla/r-architecture-HQCW1gTMjek-unsplash.jpg"] },
